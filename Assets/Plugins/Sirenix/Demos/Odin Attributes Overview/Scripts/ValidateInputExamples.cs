namespace Sirenix.OdinInspector.Demos
{
    ...
    public class ValidateInputExamples : MonoBehaviour
    {
        ...
        [Space(10)]
        [ValidateInput("HasRigidBody2DDefaultMessage", "Prefab must have a RigidBody2D")]
        [HideLabel]
        ...
        private bool HasRigidBody2DDefaultMessage(GameObject obj)
        {
            if (gameObject == null) return true;

            return obj.GetComponentInChildren<Rigidbody2D>() != null;
        }
