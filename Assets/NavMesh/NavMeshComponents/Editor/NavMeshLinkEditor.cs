    ...
    class NavMeshLinkEditor : Editor
    {
        ...
        public void OnSceneGUI()
        {
            ...
            if (navLink.GetInstanceID() == s_SelectedID && s_SelectedPoint == 0)
            {
                ...
                Handles.CubeHandleCap(0, startPt, zup, 0.1f * startSize, UnityEngine.Event.current.type);
            ...
            {
                EditorGUI.BeginChangeCheck();
                Handles.CubeHandleCap(0, endPt, zup, 0.1f * startSize, UnityEngine.Event.current.type);
